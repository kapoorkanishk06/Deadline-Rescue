...
class LightModeColors {
  ...
  static const lightPrimary = Color(0xFF4A7AFF);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8EEFF);
  static const lightOnPrimaryContainer = Color(0xFF1F3C88);

  // Secondary: Complementary gray-blue
  static const lightSecondary = Color(0xFF8FAADC);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: Subtle accent color
  static const lightTertiary = Color(0xFFB8C8D8);
  static const lightOnTertiary = Color(0xFF344451);

  // Error colors
  static const lightError = Color(0xFFE57373);
  static const lightOnError = Color(0xFFFFFFFF);
  static const lightErrorContainer = Color(0xFFFDEAEA);
  static const lightOnErrorContainer = Color(0xFF7A1E1E);
  ...
  static const lightSurfaceVariant = Color(0xFFEEF1F5);
  static const lightOnSurfaceVariant = Color(0xFF4A4A4A);

  // Outline and shadow
  static const lightOutline = Color(0xFFD0D5DD);
  static const lightShadow = Color(0xFF000000);
  static const lightInversePrimary = Color(0xFF4A7AFF);
}

/// Dark mode colors with good contrast
class DarkModeColors {
  // Primary: Lighter blue for dark background
  static const darkPrimary = Color(0xFF8FB1FF);
  static const darkOnPrimary = Color(0xFF0F172A);
  static const darkPrimaryContainer = Color(0xFF1E2A4A);
  static const darkOnPrimaryContainer = Color(0xFFE8EEFF);

  // Secondary
  static const darkSecondary = Color(0xFFAFC4E8);
  static const darkOnSecondary = Color(0xFF0F172A);

  // Tertiary
  static const darkTertiary = Color(0xFF8FA3B8);
  static const darkOnTertiary = Color(0xFFE6EDF5);

  // Error colors
  static const darkError = Color(0xFFF29B9B);
  static const darkOnError = Color(0xFF3A0D0D);
  static const darkErrorContainer = Color(0xFF7A1E1E);
  static const darkOnErrorContainer = Color(0xFFFDEAEA);
  ...
  static const darkSurfaceVariant = Color(0xFF1A2236);
  static const darkOnSurfaceVariant = Color(0xFFB0B6C3);

  // Outline and shadow
  static const darkOutline = Color(0xFF2A3550);
  static const darkShadow = Color(0xFF000000);
  static const darkInversePrimary = Color(0xFF4A7AFF);
}
